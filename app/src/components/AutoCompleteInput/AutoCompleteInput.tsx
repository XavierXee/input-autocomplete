    ...
    render() {
        return (
            <span className="AutoCompleteInput">
                ...
                <input id="AutoComplete-SearchInput" className="AutoCompleteInput--field" type="text" value={this.props.searchString} onBlur={this.handleBlur} onChange={this.handleChange} />
            </span>
        );
    }
}
